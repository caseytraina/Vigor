...
func fetchOpenAIResponse(completion: @escaping (String) -> Void) {
    let apiKey = "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" // Use your actual OpenAI API key
